...
public:
	...
	void setkeys(int host, int join, int solo, int toggle, int statup, int statdown, int quit, cyclelifetext);
...
private:
	...
	int m_host, m_join, m_solo, m_toggle, m_statup, m_statdown, m_quit, m_lifetext;
};
